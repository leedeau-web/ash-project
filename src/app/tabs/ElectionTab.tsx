...
const T = {
  bg:"#f5f6fa", surface:"#fff", accent:"#4f63d2",
  text:"#1a1f36", muted:"#8892b0", border:"#e2e8f0",
  pph:"#ef4444", pmi:"#2563eb",
};

// ── 육각형 path 생성 ──────────────────────────────────
function hexPath(cx, cy, rx=30, ry=24) {
  const pts = [];
  for(let i=0;i<6;i++){
...
// ── 지역구 데이터 ─────────────────────────────────────
const DISTRICTS = [
  { id:"yangcheon_gap",    name:"양천갑",    sub:"황희",    pph:false, oseh:false, cx:105, cy:260, rx:32, ry:24, grade:1,  note:"후보격차 -1.6%p / 비례+11.8%p",
  ...
  { id:"ydeungpo_gap",     name:"영등포갑",  sub:"채현일",  pph:false, oseh:false, cx:165, cy:258, rx:32, ry:24, grade:3,  note:"후보격차 -12.8%p / 비례+10.9%p",
  ...
  { id:"ydeungpo_eul",     name:"영등포을",  sub:"김민석",  pph:false, oseh:false, cx:222, cy:248, rx:32, ry:24, grade:1,  note:"후보격차 -1.2%p / 비례+10.9%p",
  ...
  { id:"mapo_gap",         name:"마포갑",    sub:"조정훈",  pph:true,  oseh:false, cx:205, cy:178, rx:32, ry:24, grade:0,  note:"22대 국힘 조정훈 당선",
  ...
  { id:"yongsan",          name:"용산",      sub:"권영세",  pph:true,  oseh:true,  cx:280, cy:228, rx:32, ry:24, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"jsd_eul",          name:"중성동을",  sub:"박성준",  pph:false, oseh:false, cx:345, cy:178, rx:32, ry:24, grade:1,  note:"후보격차 -2.3%p / 비례+14.0%p",
  ...
  { id:"jsd_gap",          name:"중성동갑",  sub:"전현희",  pph:false, oseh:false, cx:345, cy:228, rx:32, ry:24, grade:2,  note:"후보격차 -5.2%p / 비례+14.0%p",
  ...
  { id:"gwj_gap",          name:"광진갑",    sub:"이정헌",  pph:false, oseh:false, cx:405, cy:178, rx:32, ry:24, grade:2,  note:"후보격차 -5.0%p / 비례+7.2%p",
  ...
  { id:"gwj_eul",          name:"광진을",    sub:"고민정",  pph:false, oseh:false, cx:405, cy:228, rx:32, ry:24, grade:2,  note:"후보격차 -3.9%p / 비례+7.2%p",
  ...
  { id:"gdd_gap",          name:"강동갑",    sub:"진선미",  pph:false, oseh:false, cx:465, cy:178, rx:32, ry:24, grade:1,  note:"후보격차 -2.2%p / 비례+12.1%p",
  ...
  { id:"gdd_eul",          name:"강동을",    sub:"이해식",  pph:false, oseh:false, cx:465, cy:228, rx:32, ry:24, grade:3,  note:"후보격차 -8.8%p / 비례+12.1%p",
  ...
  { id:"hanam",            name:"하남갑",    sub:"이광재",  pph:false, oseh:false, cx:540, cy:178, rx:38, ry:28, grade:1,  note:"후보격차 -1.2%p / 비례+9.7%p",
  ...
  { id:"dja_gap",          name:"동작갑",    sub:"김병기",  pph:false, oseh:false, cx:295, cy:308, rx:32, ry:24, grade:2,  note:"후보격차 -5.5%p / 비례+10.8%p",
  ...
  { id:"dja_eul",          name:"동작을",    sub:"나경원",  pph:true,  oseh:true,  cx:355, cy:308, rx:32, ry:24, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"seocho_gap",       name:"서초갑",    sub:"조온희",  pph:true,  oseh:true,  cx:355, cy:365, rx:32, ry:24, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"gnm_gap",          name:"강남갑",    sub:"서명옥",  pph:true,  oseh:true,  cx:415, cy:308, rx:32, ry:24, grade:-1, note:"강남 텃밭",
  ...
  { id:"gnm_byung",        name:"강남병",    sub:"고동진",  pph:true,  oseh:true,  cx:475, cy:308, rx:32, ry:24, grade:-1, note:"강남 텃밭",
  ...
  { id:"gnm_eul",          name:"강남을",    sub:"박수민",  pph:true,  oseh:true,  cx:415, cy:365, rx:32, ry:24, grade:-1, note:"강남 텃밭",
  ...
  { id:"spg",              name:"송파갑",    sub:"박정훈",  pph:true,  oseh:true,  cx:535, cy:258, rx:32, ry:24, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"spb",              name:"송파병",    sub:"남인순",  pph:false, oseh:false, cx:535, cy:308, rx:32, ry:24, grade:1,  note:"후보격차 -2.1%p / 비례+19.8%p ★",
...
const DONG_DATA = {
  yangcheon_gap: {
    ...
    "신월1동": {pop:18437,hh:9866},
    "신월2동": {pop:20375,hh:8708},
    "신월3동": {pop:13497,hh:7426},
    "신월4동": {pop:16594,hh:6770},
    "신월5동": {pop:13590,hh:6354},
    "신월6동": {pop:13607,hh:5320},
    "신월7동": {pop:17848,hh:9064},
    "신정1동": {pop:19384,hh:6960},
    "신정2동": {pop:18598,hh:6875},
    "신정3동": {pop:45704,hh:18662},
    "신정4동": {pop:31102,hh:16633},
  ...
  spb: {
    ...
    "잠실6동": {pop:16063,hh:5770},
    "잠실7동": {pop:9290,hh:3362}
    },
  },
  gdd_gap: {
    chairman: "전주혜",
...
const GRADE_LABEL = { 1:"★★★ 1순위", 2:"★★ 2순위", 3:"★ 3순위", "-1":"국힘 현역", 0:"참고" };
const GRADE_COLOR = { 1:"#ef4444", 2:"#3b82f6", 3:"#f59e0b", "-1":"#8b5cf6", 0:"#64748b" };
...
function CTip({active,payload}){
  ...
  return(
    <div style={{background:"#fff",border:"1px solid #e2e8f0",borderRadius:8,padding:"8px 12px",fontSize:11}}>
      <b style={{color:T.text}}>{d?.lb}</b>
      {payload.filter(p=>p.value!=null).map((p,i)=>(
        <div key={i} style={{color:PC[p.dataKey]||T.muted}}>{PL[p.dataKey]||p.dataKey}: <b>{p.value}%</b></div>
      ))}
    </div>
  );
}
  ...
  return(
    <div style={{background:T.bg,minHeight:"100vh",fontFamily:"'Apple SD Gothic Neo','Pretendard',sans-serif",color:T.text}}>
      ...
      <div style={{background:T.surface,borderBottom:`1px solid ${T.border}`,padding:"10px 20px",display:"flex",gap:4}}>
        {[["map","🗺️ 한강벨트 분석"],["ash","📡 23ASH"]].map(([k,lb])=>(
      ...
      {/* ── 한강벨트 지도 탭 ── */}
      {tab==="map"&&(
        <div style={{display:"grid",gridTemplateColumns:"1fr 340px",height:"calc(100vh - 118px)"}}>
          ...
          <div style={{background:"#f8fafd",display:"flex",flexDirection:"column",overflow:"hidden",borderRight:`1px solid ${T.border}`}}>
            ...
            <div style={{flex:1,overflow:"auto",display:"flex",alignItems:"center",justifyContent:"center",padding:"12px"}}>
              <svg viewBox="0 0 620 430" style={{width:"100%",maxWidth:680}}>
                {/* 배경 타원 (서울 범위) */}
                <ellipse cx={320} cy={270} rx={300} ry={175} fill="#eef2ff" stroke="#c7d2fe" strokeWidth={1.5}/>

                {/* 한강 */}
                <path d="M60,225 Q150,210 280,218 Q350,222 420,215 Q490,208 570,220"
                  stroke="#93c5fd" strokeWidth={14} fill="none" strokeLinecap="round" opacity={0.5}/>
                <text x={300} y={215} fill="#60a5fa" fontSize={9} textAnchor="middle" opacity={0.8}>한 강</text>

                {/* 경기 하남 화살표 & 텍스트 */}
                <path d="M572,178 L600,162" stroke="#94a3b8" strokeWidth={1.2} strokeDasharray="4 3"/>
                <text x={604} y={160} fill="#64748b" fontSize={9}>경기도→</text>
                <text x={50} y={245} fill="#64748b" fontSize={9} transform="rotate(-90,50,245)">← 경기 강서</text>

                {/* 지역구 육각형 */}
                {DISTRICTS.map(d=>{
                  const path=hexPath(d.cx,d.cy,d.rx,d.ry);
                  const isSel=sel===d.id;
                  // 색상: 민주=파랑 계열, 국힘=빨강 계열
                  const fillBase=d.pph
                    ? (isSel?"#ef4444":"#fca5a5")   // 국힘: 선택=진빨, 기본=연빨
                    : (isSel?"#3b82f6":"#93c5fd");  // 민주: 선택=진파, 기본=연파
                  const strokeC=d.oseh?"#ef4444":(d.pph?"#f87171":"#60a5fa");
                  const strokeW=d.oseh?2.5:(isSel?2.5:1.5);

                  return(
                    <g key={d.id} style={{cursor:"pointer"}} onClick={()=>setSel(d.id===sel?null:d.id)}>
                      {/* 그림자 효과 */}
                      <path d={hexPath(d.cx+2,d.cy+3,d.rx,d.ry)} fill="rgba(0,0,0,0.08)" style={{pointerEvents:"none"}}/>
                      {/* 본체 */}
                      <path d={path} fill={fillBase} stroke={strokeC} strokeWidth={strokeW}
                  ...
                  return(
                    <g key={d.id+"_lb"} style={{pointerEvents:"none"}}>
                      <text x={d.cx} y={d.cy-4} textAnchor="middle" dominantBaseline="middle"
                        fontSize={8.5} fontWeight={700} fill={isSel?"#fff":textC}>
                        {d.name}
                      </text>
                      <text x={d.cx} y={d.cy+7} textAnchor="middle" dominantBaseline="middle"
                        fontSize={7.5} fontWeight={400} fill={isSel?"rgba(255,255,255,0.9)":textC}>
                        {d.sub}
                      </text>
                    </g>
                  );
                ...
                {targets.map(d=>{
                  ...
                  return(
                    <button key={d.id} onClick={()=>setSel(d.id)}
                      ...
                      {GRADE_LABEL[d.grade].split(" ")[0]} {d.name}
                    </button>
                  );
                })}
              </div>
            ...
            {!selD?(
                  ...
                  {targets.slice(0,8).map(d=>{
                    ...
                    return(
                      <button key={d.id} onClick={()=>setSel(d.id)}
                        ...
                        <span style={{fontSize:11,color:c,fontWeight:600}}>{GRADE_LABEL[d.grade]}</span>
                      </button>
                    );
                  })}
                </div>
              ...
              <div style={{padding:"15px 16px"}}>
                <div style={{display:"flex",alignItems:"flex-start",gap:8,marginBottom:12}}>
                  ...
                  {selD.grade!==0&&(
                    <div style={{padding:"4px 10px",borderRadius:16,fontSize:11,fontWeight:700,
                      background:GRADE_COLOR[selD.grade]+"22",color:GRADE_COLOR[selD.grade],
                      border:`1px solid ${GRADE_COLOR[selD.grade]}44`,whiteSpace:"nowrap"}}>
                      {GRADE_LABEL[selD.grade]}
                    </div>
                  )}
                ...
                {selD.grade>0&&<div style={{padding:"7px 11px",borderRadius:8,marginBottom:11,fontSize:12,
                  background:`${GRADE_COLOR[selD.grade]}11`,border:`1px solid ${GRADE_COLOR[selD.grade]}33`,
                  color:GRADE_COLOR[selD.grade]}}>💡 {selD.note}</div>}
                              ...
                              return(
                                <div key={dong} style={{background:T.bg,borderRadius:7,padding:"6px 10px",border:`1px solid ${T.border}`}}>
                                  ...
                                  <div style={{display:"flex",justifyContent:"space-between",fontSize:10,marginBottom:3}}>
                                    ...
                                    <span style={{color:isMinjoo?"#1d4ed8":"#dc2626",fontWeight:700}}>{isMinjoo?"▲민주":""}{!isMinjoo?"▲국힘":""} {Math.abs(v.mr-v.pr).toFixed(1)}%p</span>
                      ...
                      {dpKeys.length>0&&(
                        <div>
                          ...
                          <div style={{display:"flex",flexDirection:"column",gap:3}}>
                            {dpKeys.sort((a,b)=>dp[b].pop-dp[a].pop).map(dong=>{
                              const p=dp[dong];
                              const maxPop=Math.max(...dpKeys.map(d=>dp[d].pop));
          ...
          <div style={{background:T.surface,borderRadius:14,padding:"18px 8px 14px",border:`1px solid ${T.border}`,marginBottom:18}}>
            ...
            <ResponsiveContainer width="100%" height={320}>
              <LineChart data={APPROVAL} margin={{top:8,right:20,left:-10,bottom:8}}>
                ...
                {["mb","pk","mn","ys","lj"].map(k=>(
                  <Line key={k} type="monotone" dataKey={k} stroke={PC[k]} strokeWidth={2.5} dot={false} connectNulls={false}/>
                ))}
                {scenario&&<>
