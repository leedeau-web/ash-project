...
const DISTRICTS = [
  { id:"yangcheon_gap",  name:"양천갑",   sub:"황희",    pph:false, oseh:false, cx:100, cy:278, rx:32, ry:24, grade:1,  note:"후보격차 -1.6%p / 비례+11.8%p",
  ...
  { id:"ydeungpo_gap",   name:"영등포갑", sub:"채현일",  pph:false, oseh:false, cx:186, cy:278, rx:32, ry:24, grade:3,  note:"후보격차 -12.8%p / 비례+10.9%p",
  ...
  { id:"ydeungpo_eul",   name:"영등포을", sub:"김민석",  pph:false, oseh:false, cx:272, cy:278, rx:32, ry:24, grade:1,  note:"후보격차 -1.2%p / 비례+10.9%p",
  ...
  { id:"mapo_gap",       name:"마포갑",   sub:"조정훈",  pph:true,  oseh:false, cx:280, cy:175, rx:32, ry:24, grade:0,  note:"22대 국힘 조정훈 당선",
  ...
  { id:"yongsan",        name:"용산",     sub:"권영세",  pph:true,  oseh:true,  cx:370, cy:175, rx:32, ry:24, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"jsd_eul",        name:"중성동을", sub:"박성준",  pph:false, oseh:false, cx:462, cy:80,  rx:32, ry:24, grade:1,  note:"후보격차 -2.3%p / 비례+14.0%p",
  ...
  { id:"jsd_gap",        name:"중성동갑", sub:"전현희",  pph:false, oseh:false, cx:554, cy:162, rx:32, ry:24, grade:2,  note:"후보격차 -5.2%p / 비례+14.0%p",
  ...
  { id:"gwj_gap",        name:"광진갑",   sub:"이정헌",  pph:false, oseh:false, cx:610, cy:80,  rx:32, ry:24, grade:2,  note:"후보격차 -5.0%p / 비례+7.2%p",
  ...
  { id:"gwj_eul",        name:"광진을",   sub:"고민정",  pph:false, oseh:false, cx:676, cy:178, rx:32, ry:24, grade:2,  note:"후보격차 -3.9%p / 비례+7.2%p",
  ...
  { id:"gdd_gap",        name:"강동갑",   sub:"진선미",  pph:false, oseh:false, cx:876, cy:196, rx:32, ry:24, grade:1,  note:"후보격차 -2.2%p / 비례+12.1%p",
  ...
  { id:"gdd_eul",        name:"강동을",   sub:"이해식",  pph:false, oseh:false, cx:852, cy:268, rx:32, ry:24, grade:3,  note:"후보격차 -8.8%p / 비례+12.1%p",
  ...
  { id:"hanam",          name:"하남갑",   sub:"이광재",  pph:false, oseh:false, cx:972, cy:260, rx:38, ry:28, grade:1,  note:"후보격차 -1.2%p / 비례+9.7%p",
  ...
  { id:"dja_gap",        name:"동작갑",   sub:"김병기",  pph:false, oseh:false, cx:358, cy:330, rx:32, ry:24, grade:2,  note:"후보격차 -5.5%p / 비례+10.8%p",
  ...
  { id:"dja_eul",        name:"동작을",   sub:"나경원",  pph:true,  oseh:true,  cx:358, cy:420, rx:32, ry:24, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"gnm_gap",        name:"강남갑",   sub:"서명옥",  pph:true,  oseh:true,  cx:500, cy:248, rx:32, ry:24, grade:-1, note:"강남 텃밭",
  ...
  { id:"gnm_byung",      name:"강남병",   sub:"고동진",  pph:true,  oseh:true,  cx:500, cy:340, rx:32, ry:24, grade:-1, note:"강남 텃밭",
  ...
  { id:"gnm_eul",        name:"강남을",   sub:"박수민",  pph:true,  oseh:true,  cx:500, cy:420, rx:32, ry:24, grade:-1, note:"강남 텃밭",
  ...
  { id:"seocho_gap",     name:"서초갑",   sub:"조은희",  pph:true,  oseh:true,  cx:400, cy:500, rx:32, ry:24, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"spg",            name:"송파갑",   sub:"박정훈",  pph:true,  oseh:true,  cx:660, cy:248, rx:32, ry:24, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"spe",            name:"송파을",   sub:"배현진",  pph:true,  oseh:true,  cx:660, cy:340, rx:32, ry:24, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"spb",            name:"송파병",   sub:"남인순",  pph:false, oseh:false, cx:756, cy:366, rx:32, ry:24, grade:1,  note:"후보격차 -2.1%p / 비례+19.8%p ★",
...
const INSIGHTS = {
  yangcheon_gap: "20대 대선 +3.7%p 신승, 8회 지선 +19.1%p 대승. 22대 총선 -1.6%p 패배, 21대 대선 -7.0%p 패배. 비례: 국힘 37.0% vs 야권(민주 25.2%+조국혁신당 약 23%) 합산 ~48% → 야권 비례도 우위. 9회 지선 재박빙. 후보 경쟁력이 핵심 변수. ★★★ 1순위",
  ydeungpo_gap: "20대 대선 +7.0%p, 8회 지선 +21.9%p 국힘 강세. 22대 총선 -12.8%p 대패. 비례: 국힘 37.1% vs 야권(민주 26.2%+조국혁신당 약 22%) 합산 ~48% → 야권 비례도 우위. 21대 대선 -4.4%p, 9회 지선 국힘 신승. 패배 폭이 크지만 대선·지선 구조는 보수 우세. 스타 후보 전략 필요. ★★★ 1순위",
  ydeungpo_eul: "20대 대선 +7.0%p, 8회 지선 +21.9%p. 22대 총선 -1.2%p 박빙 패배. 비례: 국힘 37.1% vs 야권(민주 26.2%+조국혁신당 약 22%) 합산 ~48% → 야권 비례 우위. 9회 지선 국힘 신승. 현역 김민석의 지역 밀착력이 변수이나 정당 지지도 구조상 후보 경쟁력으로 극복 가능. ★★★ 1순위",
  mapo_gap: "22대 총선 조정훈(국힘) 당선. 비례: 국힘 34.6% vs 야권(민주 25.2%+조국혁신당 약 22%) 합산 ~47% → 야권 비례 우위. 21대 대선 -9.3%p, 9회 지선 0.3%p 초박빙. 조정훈 현역 프리미엄이 야권 비례 우위를 상쇄. 현역 유지 필수.",
  yongsan: "20대 대선 +16.5%p, 8회 지선 +31.6%p 압승. 21대 대선 +6.5%p, 9회 지선 +16.9%p. 비례: 국힘 42.3% vs 야권(민주 22.2%+조국혁신당 약 20%) 합산 ~42% → 국힘 비례도 우위. 전 선거 국힘 우세 텃밭. 현역 권영세 방어 전략.",
  jsd_eul: "20대 대선 +5.6%p, 8회 지선 +18.6%p. 22대 총선 -2.3%p 박빙 패배. 비례: 국힘 38.8% vs 야권(민주 24.8%+조국혁신당 약 22%) 합산 ~47% → 야권 비례 우위. 21대 대선 -4.8%p, 9회 지선 국힘 신승. 후보 요인만 해소하면 탈환 유력. ★★★ 1순위",
  jsd_gap: "20대 대선 +5.6%p, 8회 지선 +18.6%p. 22대 총선 -5.2%p. 비례: 국힘 38.8% vs 야권(민주 24.8%+조국혁신당 약 22%) 합산 ~47% → 야권 비례 우위. 21대 대선 -4.8%p, 9회 지선 신승. 적합 후보 발굴 시 탈환 가능. ★★ 2순위",
  gwj_gap: "20대 대선 박빙(+1.6%p), 8회 지선 +18.3%p. 22대 총선 -5.0%p. 비례: 국힘 35.8% vs 야권(민주 28.6%+조국혁신당 약 22%) 합산 ~51% → 야권 비례 우위. 21대 대선 -8.2%p, 9회 지선 신승. 이정헌 현역 극복이 과제. ★★ 2순위",
  gwj_eul: "20대 대선 박빙(+1.6%p), 8회 지선 +18.3%p. 22대 총선 -3.9%p. 비례: 국힘 35.8% vs 야권(민주 28.6%+조국혁신당 약 22%) 합산 ~51% → 야권 비례 우위. 9회 지선 초박빙(0.1%p). 고민정 현역 브랜드 강하나 교체 시 탈환 가능. ★★ 2순위",
  gdd_gap: "20대 대선 +6.9%p, 8회 지선 +22.7%p 대승. 22대 총선 -2.2%p 박빙 패배. 비례: 국힘 38.1% vs 야권(민주 26.0%+조국혁신당 약 22%) 합산 ~48% → 야권 비례 우위. 21대 대선 -3.2%p, 9회 지선 +3.7%p. 대선·지선 국힘 우세, 총선만 뒤집혀. 강동 개발 이슈 선점 필요. ★★★ 1순위",
  gdd_eul: "20대 대선 +6.9%p, 8회 지선 +22.7%p. 22대 총선 -8.8%p. 비례: 국힘 38.1% vs 야권(민주 26.0%+조국혁신당 약 22%) 합산 ~48% → 야권 비례 우위. 21대 대선 -3.2%p, 9회 지선 +3.7%p. 이해식 현역 기반 강하나 정당 구조는 박빙. ★ 3순위",
  hanam: "하남갑(경기 하남시). 20대 대선 -0.4%p 초박빙. 8회 지선 +2.6%p. 22대 총선 -1.2%p. 비례: 국힘 35.7% vs 야권(민주 26.0%+조국혁신당 약 23%) 합산 ~49% → 야권 비례 우위. 21대 대선 -11.2%p, 9회 지선 -15.6%p 민주 대승. 이재명 정부 수혜 기대심리 작동 중. 전략 후보 공천 필수. ★★★ 1순위",
  dja_gap: "20대 대선 +4.8%p, 8회 지선 +18.0%p. 22대 총선 -5.5%p. 비례: 국힘 36.4% vs 야권(민주 25.6%+조국혁신당 약 22%) 합산 ~48% → 야권 비례 우위. 21대 대선 -6.0%p, 9회 지선 신승. 동작갑은 국힘 지지 기반이 상대적으로 약해 후보 경쟁력 강화 선행 필요. ★★ 2순위",
  dja_eul: "나경원 현역. 20대 대선 +4.8%p, 8회 지선 +18.0%p, 22대 총선 +8.0%p 당선. 비례: 국힘 36.4% vs 야권(민주 25.6%+조국혁신당 약 22%) 합산 ~48% → 야권 비례 우위이나 현역 프리미엄으로 극복. 재선 방어 전략.",
  gnm_gap: "강남 전통 보수 텃밭. 비례: 국힘 50.3% vs 야권(민주 14.9%+조국혁신당 약 12%) 합산 ~27% → 국힘 비례도 압도적 우위. 야권 전체를 합해도 국힘의 절반 수준. 현역 서명옥 방어 전략.",
  gnm_byung: "강남 전통 보수 텃밭. 비례: 국힘 50.3% vs 야권 합산 ~27% → 국힘 압도. 22대 총선 +33.5%p 압승. 현역 고동진 방어 전략.",
  gnm_eul: "강남 텃밭. 비례: 국힘 50.3% vs 야권 합산 ~27% → 국힘 압도. 22대 총선 +17.2%p. 강남갑·병보다 격차 작음. 신규 유입 주민 성향 모니터링 필요. 현역 박수민 방어 전략.",
  seocho_gap: "서초 전통 보수 텃밭. 비례: 국힘 50.3% vs 야권 합산 ~27% → 국힘 압도. 22대 총선 +34.0%p 압승. 조온희 현역 방어 전략.",
  spg: "20대 대선 +16.6%p, 8회 지선 +30.7%p. 22대 총선 -5.2%p 역전 패배. 비례: 국힘 41.9% vs 야권(민주 22.1%+조국혁신당 약 21.9%) 합산 ~44% → 근소한 야권 우위. 조국혁신당이 야권표를 추가 확보해 민주 단독보다 야권이 더 강해진 구도. 21대 대선 +4.5%p, 9회 지선 +7.9%p. 여권 단일화 및 강력 후보가 핵심.",
  spe: "배현진 현역. 20대 대선 +6.9%p, 8회 지선 +15.9%p. 22대 총선 -8.9%p 패배. 비례: 국힘 38.1% vs 야권(민주 26.0%+조국혁신당 약 22%) 합산 ~48% → 야권 비례 우위. 21대 대선 +4.5%p, 9회 지선 +7.9%p. 현역 재선 도전.",
  spb: "20대 대선 +16.6%p, 8회 지선 +30.7%p 대승. 21대 대선 +4.5%p. 22대 총선 -2.1%p 박빙 패배. 비례: 국힘 41.9% vs 야권(민주 22.1%+조국혁신당 21.9%) 합산 ~44% → 조국혁신당이 야권표를 적극 흡수해 야권 합산이 커진 구도. 9회 지선 +7.9%p. 대선·지선 일관된 국힘 우세. 조국혁신당 잠식이 총선 패인. 적합 후보 발굴 시 탈환 유력. ★★★ 1순위",
};
                              ...
                              return(
                                <div key={ri} style={{background:T.bg,borderRadius:10,padding:"8px 6px",textAlign:"center"}}>
                                  ...
                                  <ResponsiveContainer width="100%" height={175}>
                                    <PieChart>
                                      <Pie data={row.data} cx="50%" cy="50%" innerRadius={35} outerRadius={68}
                                        ...
                                        label={function(props){
                                          ...
                                          const x=cx+r*Math.cos(-midAngle*RADIAN);
                                          const y=cy+r*Math.sin(-midAngle*RADIAN);
                                          return <text x={x} y={y} fill="#fff" textAnchor="middle" dominantBaseline="central" fontSize={10} fontWeight={800}>{value}%</text>;
                                        }}
                                        labelLine={false}>
