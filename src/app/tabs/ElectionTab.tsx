...
const DISTRICTS = [
  ...
  { id:"jsd_eul",        name:"중성동을", sub:"박성준",  pph:false, oseh:false, cx:340, cy:145,  rx:32, ry:24, grade:1,  note:"후보격차 -2.3%p / 비례+14.0%p",
  ...
  { id:"gwj_gap",        name:"광진갑",   sub:"이정헌",  pph:false, oseh:false, cx:550, cy:145,  rx:32, ry:24, grade:2,  note:"후보격차 -5.0%p / 비례+7.2%p",
  ...
  { id:"gwj_eul",        name:"광진을",   sub:"고민정",  pph:false, oseh:false, cx:500, cy:108, rx:32, ry:24, grade:2,  note:"후보격차 -3.9%p / 비례+7.2%p",
  ...
  { id:"gdd_gap",        name:"강동갑",   sub:"진선미",  pph:false, oseh:false, cx:700, cy:248, rx:32, ry:24, grade:1,  note:"후보격차 -2.2%p / 비례+12.1%p",
  ...
  { id:"gdd_eul",        name:"강동을",   sub:"이해식",  pph:false, oseh:false, cx:700, cy:185, rx:32, ry:24, grade:3,  note:"후보격차 -8.8%p / 비례+12.1%p",
  ...
  { id:"gnm_gap",        name:"강남갑",   sub:"서명옥",  pph:true,  oseh:true,  cx:470, cy:228, rx:32, ry:24, grade:-1, note:"강남 텃밭",
  ...
  { id:"spe",            name:"송파을",   sub:"배현진",  pph:true,  oseh:true,  cx:560, cy:228, rx:32, ry:24, grade:-1, note:"22대 국힘 현역",
