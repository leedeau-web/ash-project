...
const DISTRICTS = [
  { id:"yangcheon_gap",  name:"양천갑",   sub:"황희",    pph:false, oseh:false, cx:124, cy:278, rx:41, ry:31, grade:1,  note:"후보격차 -1.6%p / 비례+11.8%p",
  ...
  { id:"ydeungpo_gap",   name:"영등포갑", sub:"채현일",  pph:false, oseh:false, cx:206, cy:278, rx:41, ry:31, grade:3,  note:"후보격차 -12.8%p / 비례+10.9%p",
  ...
  { id:"ydeungpo_eul",   name:"영등포을", sub:"김민석",  pph:false, oseh:false, cx:288, cy:278, rx:41, ry:31, grade:1,  note:"후보격차 -1.2%p / 비례+10.9%p",
  ...
  { id:"mapo_gap",       name:"마포갑",   sub:"조정훈",  pph:true,  oseh:false, cx:304, cy:190, rx:41, ry:31, grade:0,  note:"22대 국힘 조정훈 당선",
  ...
  { id:"yongsan",        name:"용산",     sub:"권영세",  pph:true,  oseh:true,  cx:400, cy:190, rx:49, ry:36, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"jsd_gap",        name:"중성동갑", sub:"전현희",  pph:false, oseh:false, cx:582, cy:162, rx:41, ry:31, grade:2,  note:"후보격차 -5.2%p / 비례+14.0%p",
  ...
  { id:"gwj_eul",        name:"광진을",   sub:"고민정",  pph:false, oseh:false, cx:700, cy:178, rx:41, ry:31, grade:2,  note:"후보격차 -3.9%p / 비례+7.2%p",
  ...
  { id:"gdd_gap",        name:"강동갑",   sub:"진선미",  pph:false, oseh:false, cx:876, cy:206, rx:41, ry:31, grade:1,  note:"후보격차 -2.2%p / 비례+12.1%p",
  ...
  { id:"gdd_eul",        name:"강동을",   sub:"이해식",  pph:false, oseh:false, cx:836, cy:300, rx:41, ry:31, grade:3,  note:"후보격차 -8.8%p / 비례+12.1%p",
  ...
  { id:"hanam",          name:"하남갑",   sub:"이광재",  pph:false, oseh:false, cx:984, cy:260, rx:49, ry:36, grade:1,  note:"후보격차 -1.2%p / 비례+9.7%p",
  ...
  { id:"dja_gap",        name:"동작갑",   sub:"김병기",  pph:false, oseh:false, cx:382, cy:320, rx:41, ry:31, grade:2,  note:"후보격차 -5.5%p / 비례+10.8%p",
  ...
  { id:"dja_eul",        name:"동작을",   sub:"나경원",  pph:true,  oseh:true,  cx:402, cy:382, rx:41, ry:31, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"gnm_gap",        name:"강남갑",   sub:"서명옥",  pph:true,  oseh:true,  cx:524, cy:248, rx:41, ry:31, grade:-1, note:"강남 텃밭",
  ...
  { id:"gnm_byung",      name:"강남병",   sub:"고동진",  pph:true,  oseh:true,  cx:524, cy:310, rx:41, ry:31, grade:-1, note:"강남 텃밭",
  ...
  { id:"gnm_eul",        name:"강남을",   sub:"박수민",  pph:true,  oseh:true,  cx:565, cy:341, rx:41, ry:31, grade:-1, note:"강남 텃밭",
  ...
  { id:"seocho_gap",     name:"서초갑",   sub:"조은희",  pph:true,  oseh:true,  cx:490, cy:440, rx:41, ry:31, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"spg",            name:"송파갑",   sub:"박정훈",  pph:true,  oseh:true,  cx:684, cy:248, rx:41, ry:31, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"spe",            name:"송파을",   sub:"배현진",  pph:true,  oseh:true,  cx:684, cy:340, rx:41, ry:31, grade:-1, note:"22대 국힘 현역",
  ...
  { id:"spb",            name:"송파병",   sub:"남인순",  pph:false, oseh:false, cx:780, cy:366, rx:41, ry:31, grade:1,  note:"후보격차 -2.1%p / 비례+19.8%p ★",
      ...
      {tab==="map"&&(
        <div>
          ...
          <div style={{background:"#f8fafd",padding:"0 16px"}}>
            <svg viewBox="0 0 1100 520" style={{width:"100%",maxWidth:"1100px",display:"block"}}>
